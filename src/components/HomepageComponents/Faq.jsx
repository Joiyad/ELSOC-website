...
const Faq = () => {
  ...
  return (
    ...
    <Fragment>
      <Accordion className="text-white border-teal-600 border px-4 py-3 cursor-pointer rounded-lg" open={open === 1} onClick={() => handleOpen(1)}>
      ...
      <Accordion className="text-white border-teal-600 border px-4 py-3 my-8 cursor-pointer rounded-lg" open={open === 2} onClick={() => handleOpen(2)}>
      ...
      <Accordion className="text-white border-teal-600 border px-4 py-3 cursor-pointer rounded-lg" open={open === 3} onClick={() => handleOpen(3)}>
